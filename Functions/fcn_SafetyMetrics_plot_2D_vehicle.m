function fcn_SafetyMetrics_plot_2D_vehicle( ...
vehicle_position, ...
vehicle_param, ...
varargin...
)
...
vertices = [
    -(vehicle_param.w_vehicle/2), -vehicle_param.Lr; %bottom left
    (vehicle_param.w_vehicle/2), -vehicle_param.Lr; %top left
    (vehicle_param.w_vehicle/2), vehicle_param.Lf; %top right
    -(vehicle_param.w_vehicle/2), vehicle_param.Lf; %bottom right
    -(vehicle_param.w_vehicle/2), -vehicle_param.Lr%bottom left
];
...
rotated_rect = rotated_translated_rect + [vehicle_position(1,2) vehicle_position(1,3)];

plot(rotated_rect(:, 1), rotated_rect(:, 2), 'r', 'LineWidth', 2);
axis equal;
