...
% read in data
fcdData = readtable('TestTrack.csv');
...
figNum = 10;
[avTime,avPosition,nearestVehID,speedDisparity,spacing] = fcn_leadNFollowerSpeedDisparity(fcdData, sensorRange, avID, relativeTo,figNum);
