...
fileRegExp = {'res_highway_Site_1180_peak_seed*.csv',...
    ...
    directory = ['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\TrafficSimulators_Project_SUMOSimulationForADSProject\Scenarios\Scenario1_6\res\'];
fileRegExp = {'res_highway_Site_1180_peak_seed*.csv',...
    'res_highway_Site_1180_off-peak_seed*.csv',...
    'res_Arterial_Site_1136_peak_seed*.csv',...
    'res_Arterial_Site_1136_off-peak_seed*.csv',...
...
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_siteSpecificSpeed_withtraffic'],'-dsvg');
...
ylabel('Speed (mph)');
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_siteSpecificSpeed_withouttraffic'],'-dsvg');
...
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_SpeedDisparity_withTraffic'],'-dsvg');
...
ylabel({'Speed disparity of AV relative', 'to human driven vehicle (mph)'});
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_SpeedDisparity_withoutTraffic'],'-dsvg');
...
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_leadVehSpeedDisparity'],'-dsvg');
...
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_leadVehSpacing'],'-dsvg');
...
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_followVehSpeedDisparity'],'-dsvg');
...
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_followVehSpacing'],'-dsvg');
...
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_acceleration_x_withTraffic'],'-dsvg');
...
ylabel('Acceleration in X direction (m/s^2)');
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_acceleration_x_withoutTraffic'],'-dsvg');
...
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_acceleration_y_withTraffic'],'-dsvg');
...
ylabel('Acceleration in Y direction (m/s^2)');
grid on;
print(gcf,['C:\Users\tomal\OneDrive - The Pennsylvania State University\Documents\GitHub\FeatureExtraction_SafetyMetrics_SafetyMetricsClass\Fig_1_6\',sim_name,'_acceleration_y_withoutTraffic'],'-dsvg');
